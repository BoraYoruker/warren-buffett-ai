...
def call_llm_with_memory(user_prompt, vector_store, memory):
    ...
    # 2) Build refined system message (same as your original, but you can tweak if desired)
    system_message = (
        ...
        "Answer questions with a clear but/hold/sell recommendation (e.g. 'I recommend you buy AMD right now...' or 'Currently you should not buy AMD...'), "
